...
var githubApiKey = exports.githubApiKey = 'c070fb7bf7f264b8ede7f359743abab67c67251f';
...
var controllerRouter = function controllerRouter() {
   ...
   if (currentRoute.length === 0) {
      currentRoute = '';
      // fetching profile //
      var myProfilePromise = _jquery2.default.getJSON('https://api.github.com/users/BrandonC843?access_token=' + _secrets.githubApiKey);
      // fetching repos //
      var myRepositoryPromise = _jquery2.default.getJSON('https://api.github.com/users/BrandonC843/repos?access_token=' + _secrets.githubApiKey);

      // mutli-fetch promise-day24
      _jquery2.default.when(myProfilePromise, myRepositoryPromise).then(function (profileData, repositoryData) {
         appContainerEl.innerHTML = buildGitHubTemplate(profileData[0], repositoryData[0]);
      });
   }
   if (currentRoute !== '') {
      var myProfilePromise = _jquery2.default.getJSON('https://api.github.com/users/' + currentRoute);
      var myRepositoryPromise = _jquery2.default.getJSON('https://api.github.com/users/' + currentRoute + '/repos');
